...
<section class="home">
    ...
    <section class="header">
        <nav>
            <ul>
                ...
                <li><a href="home.php">Home</a><a href="stock_available.php">Available Stock</a><a href="blood_donation_camp.php">Blood Denotion</a><a href="logout.php">Logout</a></li>
    ...
    <div class="options">
        <a href="blood_donation_camp.php" class="btn">Blood Donation</a>
        <!-- <a href="/region.php" class="btn">Find a Donor</a> -->
    </div>
